...
save(['./Results/CV_LOFOPredsSpaceExpExtended_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(startYear),'_',num2str(endYear),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'preds','predVariance','leaveOutIdx');
