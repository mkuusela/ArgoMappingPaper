...
load(['./Data/Argo_data_aggr_',num2str(month,'%02d'),'.mat']);
...
save(['./Results/interpolated_',num2str(presLevel),'_',num2str(month,'%02d'),'.mat'],'interpYear','interpJulDay','interpLat','interpLong','interpFloatID','interpTemp','nInterp','startYear','endYear');