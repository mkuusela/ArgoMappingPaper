...
save(['./Results/CV_LOFOPredsSpaceTimeExp_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(startYear),'_',num2str(endYear),'.mat'],'preds','predVariance','leaveOutIdx','CVStartYear','CVEndYear');
