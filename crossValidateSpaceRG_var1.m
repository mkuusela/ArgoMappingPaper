...
for iCVYear = 1:nCVYear
    ...
    fileName = ['iterIdxCrossValidateSpaceRG_var_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVYears(iCVYear)),'.txt'];
    ...
    %for iLeaveOut = 1:nRes
        ...
        interpLatYearSel(iLeaveOut) = [];
        interpLongYearSel(iLeaveOut) = [];
        interpResYearSel(iLeaveOut) = [];
...
save(['./Results/CVPredsSpaceRG_var_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'preds','predVariance','CVStartYear','CVEndYear');
