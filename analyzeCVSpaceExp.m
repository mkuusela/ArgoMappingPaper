...
load(['./Results/CVPredsSpaceExp_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(startYear),'_',num2str(endYear),'.mat']);
...
save(['./Results/CVResultsSpaceExp_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'MSPEAll','Q3SPEAll','MdSPEAll','MAPEAll','MdAPEAll');
...
save(['./Results/pullSpaceExp_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'pull');
...
save(['./Results/coverageSpaceExp_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'coverage68','meanLength68','medianLength68','coverage95','meanLength95','medianLength95','coverage99','meanLength99','medianLength99');