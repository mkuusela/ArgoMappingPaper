...
for iCVYear = 1:nCVYear
    ...
    for iLeaveOut = 1:nLeaveOut
        ...
        sameFloat = (interpFloatIDYear(idx) == interpFloatIDYear(leaveOutIdxYear(iLeaveOut)));
...
save(['./Results/CV_LOFOPredsSpaceTimeGPML_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(startYear),'_',num2str(endYear),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'preds','predVariance','predNu','predSigma','leaveOutIdx');
