...
fileName = ['iterIdxLocalMLESpaceExpExtended_',num2str(presLevel),'_',num2str(month,'%02d'),'.txt'];
...
save(['./Results/localMLESpaceExpExtended_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(startYear),'_',num2str(endYear),'.mat'],'latGrid','longGrid','theta1Opt','theta2Opt','sigmaOpt','aOpt','nll','nResGrid');
