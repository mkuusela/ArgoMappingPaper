...
CVStartYear = 2007;
CVEndYear = 2012;
CV1 = load(['./Results/CVPredsSpaceRG_var_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat']);

CVStartYear = 2013;
CVEndYear = 2016;
CV2 = load(['./Results/CVPredsSpaceRG_var_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat']);
...
save(['./Results/CVResultsSpaceRG_var_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'MSPEAll','Q3SPEAll','MdSPEAll','MAPEAll','MdAPEAll');
...
save(['./Results/pullSpaceRG_var_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'pull');
...
save(['./Results/coverageSpaceRG_var_',num2str(presLevel),'_',num2str(month,'%02d'),'_',num2str(CVStartYear),'_',num2str(CVEndYear),'.mat'],'coverage68','meanLength68','medianLength68','coverage95','meanLength95','medianLength95','coverage99','meanLength99','medianLength99');